...
# Cell 4: Global KM OS by age decile
cells.append({
    "cell_type": "code",
    "metadata": {},
    "source": [
...
# Cell 5: Global KM EFS by age decile
cells.append({
    "cell_type": "code",
    "metadata": {},
    "source": [
...
# Cell 6: Per-cancer KM OS by age decile
cells.append({
    "cell_type": "code",
    "metadata": {},
    "source": [
...
# Cell 7: Per-cancer KM EFS by age decile
cells.append({
    "cell_type": "code",
    "metadata": {},
    "source": [
...
cells.append({
    ...
    "source": [
        ...
        "# Save\n",
        "import os\n",
        "out_dir = '/home/alon/menow_home_ass/notebooks/age_deciles'\n",
...
with open("/home/alon/menow_home_ass/notebooks/age_deciles_analysis.ipynb", "w") as f:
    json.dump(nb, f, indent=1)

print(f"Written {len(cells)} cells to age_deciles_analysis.ipynb")
